...
**Git**: free, open source version control software. Keeps track of all changes in a set of files (like a fancy "track changes"). Sits on your computer.

**GitHub**: A website to store your Git repositories online. Makes it easy to share and collaborate with others. There are other hosting services out there.

**Git client**: A helper application like a GUI that assists with Git functions and avoids having to use Git through the command line. We use the Git client built into RStudio.
